/* Selecionando os links de excluir */
const links = document.querySelectorAll(".excluir");

/* Percorrendo cada Link selecionado anteriormente (conteúdo da constante "links") */
for (const link of links) {
    ...
    link.addEventListener("click", function (event) {
       ...
       redirecionar para algum lugar.*/
        ...
        o destino original de cada link, ou seja, para a página
        PHP de exclusão. */
